    ...
    return (
        <section>
            <div className=' text-center py-4'>
                <h2 className=' decoration-stone-600 font-extrabold text-3xl'>Coronavirus Update Global</h2>
            </div>
            <div>
                    ...
                    <div className="container mx-auto">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    className="border-2 bg-blue-700 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                            ...
                            <div
                                ...
                                <div
                                    className="border-2  bg-red-400  border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                            ...
                            <div
                                ...
                                <div
                                    className="border-2  bg-green-500 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                            ...
                            <div
                                ...
                                <div
                                    className="border-2 bg-teal-400  border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                            ...
                            <div
                                ...
                                <div
                                    className="border-2 bg-red-900  border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                            ...
                            <div
                                ...
                                <div
                                    className="border-2 bg-yellow-400  border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
